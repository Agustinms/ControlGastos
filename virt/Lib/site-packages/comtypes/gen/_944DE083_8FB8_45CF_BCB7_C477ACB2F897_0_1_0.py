...
__all__ = [
    'IUIAutomationNotCondition', 'UIA_LocalizedControlTypePropertyId',
    'UIA_DockDockPositionPropertyId',
    'TextEditChangeType_CompositionFinalized',
    'UIA_BulletStyleAttributeId',
    'UIA_IsWindowPatternAvailablePropertyId', 'HeadingLevel2',
    'NotificationProcessing_ImportantAll',
    'UIA_FontWeightAttributeId',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'TextEditChangeType_Composition',
    'AnnotationType_DataValidationError',
    'UIA_HyperlinkControlTypeId', 'IUIAutomationTextPattern',
    'IUIAutomationElement9', 'UIA_AriaPropertiesPropertyId',
    'UIA_TableItemPatternId',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_RangeValuePatternId', 'UIA_RangeValueValuePropertyId',
    'UIA_AriaRolePropertyId', 'UIA_RadioButtonControlTypeId',
    'UIA_Invoke_InvokedEventId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'DockPosition_Right', 'UIA_AnnotationAuthorPropertyId',
    'UIA_Selection_InvalidatedEventId', 'UIA_TreeItemControlTypeId',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_GridItemContainingGridPropertyId',
    'ProviderOptions_OverrideProvider', 'UIA_TitleBarControlTypeId',
    'TreeScope_Ancestors', 'WindowVisualState', 'UIA_TabsAttributeId',
    'ExpandCollapseState_Expanded', 'UIA_AppBarControlTypeId',
    'ScrollAmount_SmallIncrement',
    'UIA_IsTableItemPatternAvailablePropertyId', 'TreeScope',
    'SynchronizedInputType_LeftMouseUp',
    'UIA_DragGrabbedItemsPropertyId', 'IUIAutomationElement7',
    'UIA_ScrollBarControlTypeId',
    'UIA_IsGridPatternAvailablePropertyId', 'UIA_TextEditPatternId',
    'UIA_FontNameAttributeId', 'IUIAutomationDockPattern',
    'UIA_AnnotationTargetPropertyId',
    'SupportedTextSelection_Multiple',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'UIA_DragIsGrabbedPropertyId', 'UIA_BackgroundColorAttributeId',
    'UIA_LegacyIAccessibleChildIdPropertyId', 'IUIAutomationElement4',
    'UIA_AccessKeyPropertyId', 'UIA_LabeledByPropertyId',
    'StyleId_Heading2',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'IUIAutomationTransformPattern2',
    'UIA_StrikethroughStyleAttributeId',
    'IUIAutomationTextEditPattern', 'UIA_ValuePatternId',
    'IUIAutomationWindowPattern', 'UIA_TextEdit_TextChangedEventId',
    'UIA_ItemStatusPropertyId', 'DockPosition_Fill',
    'ProviderOptions', 'UIA_IsItalicAttributeId',
    'WindowInteractionState_Closing', 'ExpandCollapseState',
    'UIA_GridPatternId', 'UIA_CulturePropertyId',
    'UIA_SemanticZoomControlTypeId', 'IUIAutomationElementArray',
    'HeadingLevel_None', 'UIA_ComboBoxControlTypeId',
    'UIA_OrientationPropertyId', 'UIA_ListControlTypeId',
    'NotificationKind_Other', 'IUIAutomationTransformPattern',
    'StyleId_Heading6', 'DockPosition_Left', 'UIA_HelpTextPropertyId',
    'UIA_InputReachedTargetEventId', 'IUIAutomationTablePattern',
    'NavigateDirection_Parent', 'ExpandCollapseState_Collapsed',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'ProviderOptions_RefuseNonClientSupport', 'HeadingLevel7',
    'UIA_TextFlowDirectionsAttributeId',
    'IUIAutomationPropertyCondition', 'HeadingLevel4',
    'UIA_LinkAttributeId', 'OrientationType_None',
    'UIA_StyleIdAttributeId', 'UIA_IsValuePatternAvailablePropertyId',
    'UIA_IsTogglePatternAvailablePropertyId',
    'UIA_AutomationFocusChangedEventId',
    'UIA_TransformCanResizePropertyId', 'IUIAutomationDragPattern',
    'IUIAutomationScrollPattern', 'SynchronizedInputType',
    'UIA_EditControlTypeId', 'UIA_OutlineColorPropertyId',
    'IUIAutomationStylesPattern',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'IUIAutomationAnnotationPattern',
    'UIA_AnnotationObjectsAttributeId', 'IUIAutomationElement6',
    'NotificationProcessing_All', 'UIA_WindowCanMaximizePropertyId',
    'UIA_RangeValueMinimumPropertyId', 'StyleId_Heading5',
    'UIA_AnnotationDateTimePropertyId',
    'IUIAutomationGridItemPattern', 'UIA_MenuControlTypeId',
    'TextUnit_Format', 'ToggleState_On', 'TextUnit_Page',
    'UIA_HeadingLevelPropertyId', 'UIA_IsActiveAttributeId',
    'NotificationProcessing', 'UIA_SeparatorControlTypeId',
    'HeadingLevel3', 'StyleId_Subtitle', 'AnnotationType_Highlighted',
    'IUIAutomationPropertyChangedEventHandler', 'StyleId_Heading3',
    'TextEditChangeType_AutoCorrect', 'ScrollAmount',
    'IUIAutomationProxyFactoryMapping',
    'IUIAutomationItemContainerPattern',
    'NotificationKind_ItemRemoved', 'UIA_MenuModeStartEventId',
    'UIA_CaretBidiModeAttributeId', 'UIA_ValueValuePropertyId',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'IUIAutomationTextRange2', 'IUIAutomation4',
    'ScrollAmount_NoAmount', 'IUIAutomationTextPattern2',
    'ProviderOptions_ServerSideProvider',
    'UIA_GridRowCountPropertyId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_TransformPatternId', 'AnnotationType_Mathematics',
    'UIA_FullDescriptionPropertyId', 'IUIAutomationTextChildPattern',
    'UIA_FrameworkIdPropertyId', 'UIA_ControlTypePropertyId',
    'UIA_TreeControlTypeId', 'HeadingLevel8',
    'UIA_Drag_DragStartEventId', 'AnnotationType_MoveChange',
    ...
    'UIA_DropTarget_DragLeaveEventId', 'ToggleState_Off',
    'DockPosition', 'TextEditChangeType_None',
    'TextPatternRangeEndpoint_Start', 'SupportedTextSelection_Single',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'ProviderOptions_UseComThreading', 'ZoomUnit_SmallIncrement',
    'TreeScope_Subtree', 'UIA_AnnotationAnnotationTypeIdPropertyId',
    'TreeScope_Children', 'IUIAutomation',
    'UIA_NavigationLandmarkTypeId', 'IUIAutomationProxyFactory',
    'StructureChangeType_ChildrenBulkRemoved',
    'ZoomUnit_LargeDecrement', 'UIA_ScrollVerticalViewSizePropertyId',
    'TextUnit', 'UIA_GroupControlTypeId', 'UIA_ChangesEventId',
    'UIA_SpreadsheetItemFormulaPropertyId', 'CUIAutomation',
    'UIA_DocumentControlTypeId', 'UIA_ControllerForPropertyId',
    'UIA_DragDropEffectsPropertyId', 'WindowInteractionState',
    'UIA_IndentationFirstLineAttributeId',
    'PropertyConditionFlags_IgnoreCase',
    'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_TabItemControlTypeId', 'UIA_DataGridControlTypeId',
    'ToggleState', 'UIA_IsDragPatternAvailablePropertyId',
    'IUIAutomationEventHandlerGroup', 'UIA_CustomControlTypeId',
    'TreeScope_Descendants', 'UIA_SelectionActiveEndAttributeId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_FontSizeAttributeId', 'StyleId_BulletedList',
    'UIA_LevelPropertyId', 'UIA_RangeValueMaximumPropertyId',
    'UIA_ActiveTextPositionChangedEventId',
    'UIA_StylesExtendedPropertiesPropertyId',
    'UIA_TableColumnHeadersPropertyId', 'UIA_WindowPatternId',
    'ProviderOptions_NonClientAreaProvider', 'DockPosition_None',
    'NotificationKind_ActionCompleted', 'UIA_TableControlTypeId',
    'UIA_IsHiddenAttributeId', 'UIA_ScrollPatternId',
    'UIA_SummaryChangeId', 'UIA_ValueIsReadOnlyPropertyId',
    'UIA_IsDialogPropertyId', 'AnnotationType_SpellingError',
    'IUIAutomation3', 'UIA_BeforeParagraphSpacingAttributeId',
    ...
    'IUIAutomationDropTargetPattern', 'ExtendedProperty',
    'UIA_UnderlineStyleAttributeId', 'TreeScope_Parent',
    'NotificationKind_ActionAborted',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'UIA_StylesFillPatternColorPropertyId', 'UIA_NamePropertyId',
    'StyleId_Heading8', 'SynchronizedInputType_LeftMouseDown',
    'StyleId_Emphasis',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_LiveRegionChangedEventId',
    'UIA_SelectionItemSelectionContainerPropertyId', 'IAccessible',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_ToolTipControlTypeId', 'NavigateDirection_PreviousSibling',
    'UIA_InvokePatternId', 'UIA_ClassNamePropertyId',
    'UIA_DataItemControlTypeId', 'UIA_IndentationTrailingAttributeId',
    'TextUnit_Character', 'UIA_DropTarget_DragEnterEventId',
    'OrientationType_Horizontal', 'UIA_AnnotationTypesAttributeId',
    'UIA_ProgressBarControlTypeId', 'UIA_CustomNavigationPatternId',
    'NotificationProcessing_MostRecent',
    'IUIAutomationExpandCollapsePattern',
    'IUIAutomationSpreadsheetPattern', 'AutomationElementMode_None',
    'IUIAutomationTreeWalker', 'UIA_MenuClosedEventId',
    'UIA_Transform2ZoomMaximumPropertyId', 'UIA_SystemAlertEventId',
    'IUIAutomationNotificationEventHandler',
    'UIA_SelectionSelectionPropertyId', 'UIA_TablePatternId',
    'TextUnit_Paragraph', 'IUIAutomationTextRangeArray',
    'UIA_Text_TextChangedEventId', 'UIA_MenuItemControlTypeId',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'UIA_UnderlineColorAttributeId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'UIA_ProcessIdPropertyId', 'WindowVisualState_Minimized',
    ...
    'UIA_SpreadsheetItemAnnotationTypesPropertyId', 'HeadingLevel9',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'AnnotationType_Unknown', 'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_StructureChangedEventId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'StyleId_NumberedList',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'UIA_VisualEffectsPropertyId', 'IUIAutomationElement5',
    'TreeTraversalOptions_LastToFirstOrder',
    'UIA_IsPasswordPropertyId',
    'UIA_WindowWindowVisualStatePropertyId',
    'IUIAutomationMultipleViewPattern', 'UIA_InputDiscardedEventId',
    'RowOrColumnMajor', 'TreeScope_Element',
    'UIA_SelectionPattern2Id', 'UIA_TableRowHeadersPropertyId',
    'ProviderOptions_ProviderOwnsSetFocus', 'UIA_SizeOfSetPropertyId',
    'UIA_ThumbControlTypeId', 'UIA_FlowsToPropertyId',
    'CoalesceEventsOptions_Enabled', 'UIA_ItemTypePropertyId',
    'AnnotationType_Sensitive', 'UIA_CalendarControlTypeId',
    'UIA_ScrollHorizontalScrollPercentPropertyId', 'CUIAutomation8',
    'AutomationElementMode', 'UIA_DescribedByPropertyId',
    'IUIAutomationTextRange', 'IUIAutomationGridPattern',
    'IUIAutomationOrCondition',
    'WindowInteractionState_ReadyForUserInteraction',
    'UIA_WindowControlTypeId', 'IUIAutomationValuePattern',
    'AnnotationType_TrackChanges', 'UIA_AcceleratorKeyPropertyId',
    'TreeTraversalOptions_Default',
    'UIA_ProviderDescriptionPropertyId',
    'UIA_LegacyIAccessibleHelpPropertyId', 'UIA_RotationPropertyId',
    'AnnotationType_EditingLockedChange', 'StyleId_Heading4',
    'StyleId_Title', 'UIA_IsItemContainerPatternAvailablePropertyId',
    'RowOrColumnMajor_ColumnMajor', 'UIA_IsControlElementPropertyId',
    'UIA_LocalizedLandmarkTypePropertyId',
    'UIA_OutlineThicknessPropertyId', 'UIA_MenuModeEndEventId',
    'UIA_Drag_DragCancelEventId', 'UIA_FlowsFromPropertyId',
    'StructureChangeType_ChildAdded',
    'UIA_IsTablePatternAvailablePropertyId', 'DockPosition_Bottom',
    'IUIAutomationCustomNavigationPattern',
    'UIA_AsyncContentLoadedEventId',
    'UIA_MultipleViewCurrentViewPropertyId',
    'UIA_WindowCanMinimizePropertyId', 'UIA_TextChildPatternId',
    'UIA_MenuOpenedEventId', 'UIA_HeaderControlTypeId',
    'AnnotationType_InsertionChange', 'Polite',
    'AnnotationType_ConflictingChange', 'UIA_ToolTipOpenedEventId',
    'StyleId_Heading1', 'IUIAutomationTogglePattern',
    'UIA_Transform2ZoomMinimumPropertyId', 'IUIAutomation2',
    'IUIAutomationStructureChangedEventHandler',
    'UIA_CapStyleAttributeId', 'RowOrColumnMajor_RowMajor',
    'IUIAutomationTableItemPattern', 'UIA_ClickablePointPropertyId',
    'UIA_IsSubscriptAttributeId', 'TextEditChangeType_AutoComplete',
    'AnnotationType_GrammarError', 'IUIAutomationChangesEventHandler',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'SynchronizedInputType_KeyDown', 'UIA_IsPeripheralPropertyId',
    'UIA_Selection2ItemCountPropertyId',
    'UIA_OptimizeForVisualContentPropertyId', 'Assertive',
    'IRawElementProviderSimple', 'HeadingLevel6',
    'IUIAutomationScrollItemPattern',
    'UIA_LegacyIAccessibleNamePropertyId',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_IsReadOnlyAttributeId', 'UIA_IsRequiredForFormPropertyId',
    'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_IsDataValidForFormPropertyId', 'UIA_AutomationIdPropertyId',
    'UIA_ExpandCollapsePatternId',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_DropTarget_DroppedEventId', 'TreeTraversalOptions',
    'AnnotationType_FormatChange',
    'UIA_IsDockPatternAvailablePropertyId', 'NotificationKind',
    'NavigateDirection', 'UIA_WindowIsModalPropertyId',
    'TextPatternRangeEndpoint_End', 'UIA_SayAsInterpretAsAttributeId',
    'ProviderOptions_HasNativeIAccessible',
    'UIA_SayAsInterpretAsMetadataId',
    'UIA_IndentationLeadingAttributeId', 'DockPosition_Top',
    'IUIAutomationElement2', 'UIA_ButtonControlTypeId',
    'IUIAutomationSelectionPattern', 'UIA_MarginTrailingAttributeId',
    'UIA_ImageControlTypeId', 'UIA_StatusBarControlTypeId',
    'NavigateDirection_NextSibling', 'UIA_SelectionPatternId',
    'AnnotationType_Author', 'HeadingLevel1',
    'AutomationElementMode_Full', 'UIA_StylesFillColorPropertyId',
    'SupportedTextSelection', 'UIA_ItemContainerPatternId',
    'UIA_TransformCanMovePropertyId',
    'StructureChangeType_ChildRemoved', 'UIA_MainLandmarkTypeId',
    'UIA_StrikethroughColorAttributeId',
    'UIA_InputReachedOtherElementEventId', 'ZoomUnit',
    'IUIAutomationObjectModelPattern',
    'UIA_WindowIsTopmostPropertyId', 'UIA_LiveSettingPropertyId',
    'AnnotationType_FormulaError',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_FillColorPropertyId', 'UIA_DockPatternId',
    'IUIAutomationElement3', 'SynchronizedInputType_RightMouseDown',
    'UIA_CustomLandmarkTypeId', 'UIA_OutlineStylesAttributeId',
    'UIA_ListItemControlTypeId', 'UIA_PaneControlTypeId',
    'UIA_DragPatternId', 'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_IsKeyboardFocusablePropertyId', 'AnnotationType_Header',
    'NavigateDirection_FirstChild', 'IUIAutomationRangeValuePattern',
    'UIA_TextControlTypeId', 'UIA_OverlineColorAttributeId',
    'UIA_RangeValueLargeChangePropertyId', 'TextUnit_Line',
    'UIA_ToolTipClosedEventId', 'UIA_StylesStyleNamePropertyId',
    'StyleId_Quote', 'IUIAutomationElement',
    ...
    'NotificationKind_ItemAdded', 'UIA_ScrollItemPatternId',
    'UIA_IsEnabledPropertyId', 'UIA_SliderControlTypeId',
    'UIA_BoundingRectanglePropertyId',
    'UIA_IsTransformPattern2AvailablePropertyId', 'StyleId_Custom',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_PositionInSetPropertyId', 'UIA_DragDropEffectPropertyId',
    'StructureChangeType', 'UIA_TransformPattern2Id',
    'UIA_LegacyIAccessibleStatePropertyId',
    'UIA_Text_TextSelectionChangedEventId',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_OverlineStyleAttributeId', 'StyleId_Heading9',
    'UIA_SpinnerControlTypeId', 'ToggleState_Indeterminate',
    'IUIAutomationCacheRequest', 'UIA_AnnotationTypesPropertyId',
    'RowOrColumnMajor_Indeterminate',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'WindowVisualState_Normal', 'AnnotationType_Comment',
    'UIA_StylesStyleIdPropertyId', 'UIA_RuntimeIdPropertyId',
    'IUIAutomationCondition',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'UIA_IsContentElementPropertyId', 'UIA_GridItemColumnPropertyId',
    'UIA_FormLandmarkTypeId', 'UIA_HeaderItemControlTypeId',
    'ScrollAmount_SmallDecrement',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_RangeValueSmallChangePropertyId', 'ZoomUnit_LargeIncrement',
    'IUIAutomationProxyFactoryEntry', 'TreeScope_None',
    'UIA_SearchLandmarkTypeId', 'UIA_GridItemColumnSpanPropertyId',
    'UIA_MarginBottomAttributeId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'AnnotationType_UnsyncedChange', 'UIA_TabControlTypeId',
    'IUIAutomationEventHandler', 'UIA_SpreadsheetItemPatternId',
    'UIA_SplitButtonControlTypeId', 'PropertyConditionFlags',
    'UIA_AnimationStyleAttributeId',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_StylesShapePropertyId', 'TextUnit_Document',
    'UIA_Selection2LastSelectedItemPropertyId',
    'UIA_LineSpacingAttributeId', 'AnnotationType_Footer',
    'UIA_NotificationEventId', 'UIA_TableRowOrColumnMajorPropertyId',
    'UIA_ObjectModelPatternId', 'UIA_AnnotationPatternId',
    'ZoomUnit_SmallDecrement', 'UIA_CultureAttributeId',
    'UIA_Transform2ZoomLevelPropertyId',
    'CoalesceEventsOptions_Disabled', 'IUIAutomationTextRange3',
    'NavigateDirection_LastChild', 'UIA_GridColumnCountPropertyId',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_SpreadsheetPatternId',
    'UIA_IsTextChildPatternAvailablePropertyId',
    'ConnectionRecoveryBehaviorOptions', 'IUIAutomation6',
    'ExpandCollapseState_PartiallyExpanded', 'TextEditChangeType',
    'UIA_TextPattern2Id', 'UIA_VirtualizedItemPatternId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_TableItemRowHeaderItemsPropertyId', 'UIA_TogglePatternId',
    'UIA_IsTextPatternAvailablePropertyId',
    'NotificationProcessing_CurrentThenMostRecent',
    'WindowVisualState_Maximized', 'UIA_ToolBarControlTypeId',
    'IUIAutomation5', 'SupportedTextSelection_None',
    'UIA_ForegroundColorAttributeId', 'UiaChangeInfo',
    'IUIAutomationSelectionPattern2',
    'UIA_TransformCanRotatePropertyId',
    'IUIAutomationFocusChangedEventHandler', 'UIA_SizePropertyId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'UIA_MarginTopAttributeId', 'UIA_Window_WindowOpenedEventId',
    'IUIAutomationSynchronizedInputPattern',
    'IUIAutomationAndCondition', 'ScrollAmount_LargeIncrement',
    'UIA_CaretPositionAttributeId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'ZoomUnit_NoAmount', 'TextUnit_Word', 'UIA_TextPatternId',
    'StructureChangeType_ChildrenReordered',
    'UIA_CheckBoxControlTypeId', 'UIA_MultipleViewPatternId',
    'HeadingLevel5', 'UIA_Transform2CanZoomPropertyId',
    'IUIAutomationBoolCondition',
    'UIA_StylesFillPatternStylePropertyId',
    'UIA_GridItemRowSpanPropertyId', 'SynchronizedInputType_KeyUp',
    'UIA_Drag_DragCompleteEventId',
    'ProviderOptions_ClientSideProvider', 'UIA_CenterPointPropertyId',
    'UIA_SynchronizedInputPatternId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_MenuBarControlTypeId',
    'UIA_HostedFragmentRootsInvalidatedEventId',
    'UIA_StylesPatternId', 'IUIAutomationElement8',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_LegacyIAccessiblePatternId', 'UIA_LayoutInvalidatedEventId',
    'ExpandCollapseState_LeafNode',
    'ProviderOptions_UseClientCoordinates',
    'UIA_WindowWindowInteractionStatePropertyId',
    'WindowInteractionState_NotResponding', 'UIA_DropTargetPatternId',
    'StyleId_Normal', 'UIA_NativeWindowHandlePropertyId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_AfterParagraphSpacingAttributeId',
    'IUIAutomationInvokePattern',
    'AnnotationType_AdvancedProofingIssue', 'AnnotationType_Footnote',
    'LiveSetting', 'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_LandmarkTypePropertyId', 'StyleId_Heading7',
    'OrientationType', 'ConnectionRecoveryBehaviorOptions_Enabled',
    'PropertyConditionFlags_None', 'Off', 'UIA_GridItemPatternId',
    ...
    'UIA_FillTypePropertyId', 'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_GridItemRowPropertyId', 'UIA_HasKeyboardFocusPropertyId',
    'TreeTraversalOptions_PostOrder', 'CoalesceEventsOptions',
    'TextPatternRangeEndpoint',
    'UIA_AutomationPropertyChangedEventId',
    'UIA_IsSuperscriptAttributeId', 'WindowInteractionState_Running',
    'WindowInteractionState_BlockedByModalWindow'
]

_check_version('1.1.14', 1660424762.388228)
